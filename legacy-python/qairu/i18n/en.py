STRINGS = {
    ...
    "remind_text": "⏰ {names} — please fill in your schedule, we can't compute common windows without you.",
    ...
    "avail_none": "No common windows longer than {min} min in the next week 😕\nTry /availability 30 or a different set of people.",
    ...
    "avail_user_not_found": "I don't know the user {name}. They need to /join and fill in a schedule.",
    ...
    "meeting_step2_manual": "📌 Step 2 of 3 — write the meeting time, e.g.:\n<code>Wednesday 15:00-16:30</code>",
...
# --- additions: week parity, busy kinds, quorum, reminders ---
STRINGS.update({
    ...
    "avail_quorum_title": "<b>🗓 Windows where at least {quorum} of {total} are free</b>\n<i>{who}</i>\n",
...
# --- v1.2: web version, meeting cancellation, calendar, leaving a chat ---
STRINGS.update({
    "avail_clipped": "…list trimmed to fit one message. Narrow it down: /availability 90 or name specific people.",
...
STRINGS.update({
    ...
    'w_footer': 'QairuCowork — shared free windows for student groups. Works in Telegram and in the browser.',
    'w_hero_title': 'When is everyone free?',
    'w_hero_lead': 'Everyone marks their classes once. The site then shows when the whole group is free — and when almost all of it is.',
    ...
    'w_step3_d': 'Colour shows where everyone is free and where eight out of ten are. Meetings start right there.',
    ...
    'w_me_lead': "Mark when you're busy: classes, work, training. The free time is worked out for you.",
