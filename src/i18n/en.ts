...
export const EN: Dict = {
  ...
  remind_semester_text: "🎓 A new semester has started! {names}, please update your schedules — the old ones will give wrong windows.",
  notify_semester_dm: "🎓 A new semester has started in “{chat}” — {name} asks you to update your schedule. Mark your new classes, it takes a minute.",
  ...
  repeat_suffix: "🔁 every week until {until}",
  ...
  w_who_hint: "Untick anyone the meeting can go ahead without — the windows are recalculated. People without a schedule are not counted. Hover a name to see on the map when that person is free.",
  ...
  w_rows_trimmed: "Hours when nobody is free are hidden.",
  w_rows_show_all: "Show all hours",
  w_rows_hide_empty: "Hide empty hours",
  w_copy_windows: "Copy for chat",
  w_copied_windows: "Windows copied — paste them into the group chat",
  w_copy_head: "Common windows · {duration}:",
  w_copy_without: "without {names}",
  w_now: "Now",
  w_best_hide: "Hide “Best time”",
  w_best_show: "Show",
  w_sidebar_collapse: "Collapse sidebar",
  w_sidebar_expand: "Expand sidebar",
  w_side_meetings: "Upcoming meetings",
  w_meetings_count_one: "{n} meeting",
  w_meetings_count_few: "{n} meetings",
  w_meetings_count_many: "{n} meetings",
  w_meetings_count_other: "{n} meetings",
  w_side_going: "{n}/{total} going",
  w_side_awaiting: "Waiting for your answer",
  w_in_minutes: "in {n} min",
  w_in_hours: "in {n} h",
  w_side_today: "Today, {time}",
  w_side_tomorrow: "Tomorrow, {time}",
  w_contact_dev: "Found a bug or have an idea? Message the developer on Telegram:",
  ...
  w_heat_hint_mobile: "Pick a day — each slot shows how many people are free and who is missing. Swipe between days, tap a row to schedule a meeting.",
  w_legend_soft: "inconvenient for someone",
  w_soft_names: "inconvenient: {names}",
  w_legend_soft_mine: "inconvenient",
  w_brush_label: "What to mark",
  w_brush_busy: "Busy",
  w_brush_soft: "Inconvenient",
  notify_summary: "📝 <b>{name}</b> wrote the outcome of “{goal}”:\n\n{summary}",
  w_notice_summary: "{name} wrote the outcome of “{goal}”.",
  w_summary_title: "Outcome",
  w_summary_ph: "What you decided and who does what next",
  w_summary_edit: "Edit outcome",
  w_summary_save: "Save outcome",
  w_summary_saved: "Outcome saved",
  w_summary_by: "{name}, {date}",
  w_repeat_meeting: "Repeat",
  w_cal_sub_title: "My calendar",
  w_cal_sub_lead: "Connect Google Calendar, Outlook or your university calendar — your busy time will sync by itself every few hours. The group only sees that you are busy, not event titles.",
  w_cal_sub_url: "Calendar link in iCal (.ics) format",
  w_cal_sub_help: "Google Calendar: calendar settings → “Secret address in iCal format”. Outlook: Settings → Calendar → Shared calendars → Publish → ICS link.",
  w_cal_sub_connect: "Connect",
  w_cal_sub_connected: "Connected: {host}",
  w_cal_sub_synced: "Updated {date} at {time} · busy slots ahead: {n}",
  w_cal_sub_never: "Not loaded yet",
  w_cal_sub_refresh: "Update now",
  w_cal_sub_remove: "Disconnect",
  w_cal_sub_remove_confirm: "Disconnect the calendar? Busy time from it will disappear from your schedule.",
  w_cal_sub_ok: "Calendar loaded",
  w_cal_sub_removed: "Calendar disconnected",
  w_cal_err_bad_url: "This doesn't look like a calendar link. It should start with https:// or webcal://.",
  w_cal_err_blocked: "This link points into a private network — such addresses can't be loaded.",
  w_cal_err_unreachable: "Couldn't download the calendar. Check that the link opens without signing in.",
  w_cal_err_not_ics: "The link isn't a calendar. You need an iCal (.ics) link, not the calendar page address.",
  w_cal_err_too_large: "The calendar is too large — over 2 MB.",
  notify_conflict_self: "⚠️ You're going to “{goal}” ({when}), but your schedule now has you busy at that time. If you can't make it, answer “no” or suggest another time.",
  notify_conflict_other: "⚠️ {name} is now busy during “{goal}” ({when}).",
  w_notice_conflict: "You're going to “{goal}”, but your schedule now has you busy at that time.",
  w_notice_conflict_other: "{name} is now busy during “{goal}”.",
  w_qr_title: "Invite QR code",
  w_qr_hint: "Put it on the classroom screen — classmates point their camera and join right away.",
  w_qr_full: "Full screen",
  w_qr_label: "Invite QR code for “{title}”",
  w_install_app: "Install as an app",
  w_heat_hint: "The colour shows how many people are free — see the scale under the table, from “everyone” to “nobody”. Hover a cell to see who. Drag across a day's cells to put that time into the meeting form.",
  ...
  w_schedule_stale: "schedule outdated",
  w_updated_on: "updated {date}",
  w_my_schedule_stale: "Your schedule is from last semester. Update it so the windows use your new classes.",
  w_update_schedule: "Update",
  w_semester_started: "New semester started — everyone was asked to update their schedule.",
  w_semester_new_title: "Has a new semester started?",
  w_semester_new_lead: "Schedules saved before will be marked outdated, and the bot will ask everyone to update theirs. Until someone updates, the windows use their old schedule.",
  w_semester_new_btn: "Start a new semester",
  w_semester_new_confirm: "Start a new semester? The semester start becomes today, everyone's schedule is marked outdated and the bot asks each person to update it.",
  w_notice_semester: "🎓 {name}: a new semester has started — update your schedule.",
  w_members: "Members",
  w_filled: "filled in",
  w_not_filled: "not filled in",
  w_edit_mine: "My schedule",
  w_cancel: "Cancel",
  w_cal_title: "Group calendar",
  w_cal_lead: "Subscribe once — the group’s meetings appear in your calendar and stay up to date. The link is personal, do not share it.",
  w_cal_google: "Google Calendar",
  w_cal_apple: "Apple and Outlook",
  w_cal_copy: "Copy link",
  w_repeat: "Repeat every week",
  w_repeat_until: "Until",
  w_repeat_hint: "A meeting can repeat weekly if its time was picked with the “Pick” button.",
  w_repeat_meta: "every week: {day} {time}, until {until}",
  w_meetings: "Meetings",
  ...
  w_clear: "Clear all",
  w_tpl_title: "Quick:",
  w_tpl_evenings: "Busy weekdays after 18:00",
  w_tpl_weekend_free: "Weekends free",
  w_tpl_weekend_busy: "Weekends busy",
  ...
  w_hours_from: "From",
  w_hours_to: "To",
  w_buffer_hint: "Travel buffer — how many minutes to leave between a class and a meeting, e.g. to walk to another building. 0 means a meeting can start right after class.",
  ...
  w_duration_h: "{h} h",
  w_duration_m: "{m} min",
  w_variants: "{n} windows",
  w_more_days: "and {n} more",
